...
const q2 = `When you get off the elevator something startles you!
1. Look to see what it is 
OR
2. Shoot at it immediately with your proton pack
${enter}`;

const gameOver2 = `It was the hotel maid and you nearly killed her, You are forced to leave the hotel. 
${gameOver}`
...
const q5 = `You wrangles Slimer with your shot adn ghost trap is set underneath him. You noticed there is a bright light coming from the trap and are tempter to look at it. Should you...
1. Look at the trap
OR
...
// Sets the value of userInput to the user's entry and allows for change with let
